...
<main id="main">
<div id="find-password-main">
	<h1>비밀번호 찾기</h1>

	<p>
		<br />비밀번호를 잊으셨나요? <br />ID, 이름, 생년월일을 입력하시면 <br /> 가입시 입력한 이메일로
		임시비밀번호를 발송해 드립니다.<br />
	</p>


	<form id="find-password">
		<fieldset>
			<div id="id">
				<label>ID</label><input type="text" name="id" placeholder="id" />
			</div>
			<div id="name">
				<label>이름</label><input type="text" name="name" placeholder="name" />
			</div>
			<div id="birthday">
			...
			<div id=check>
				<input id="" type="button" value=Find /><a href="" class="button"></a>
			</div>
		</fieldset>
	</form>
