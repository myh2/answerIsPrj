	...
	<fieldset>
		<div id="email-check">
			<label>E-mail</label> <input type="text" name="email"
				placeholder="E-mail" /> <input type="button" value="인증" /> <img
				class="verification-img" src="../../resource/images/required.png" />
		</div>
		<div id="code-check">
			<label>E-mail 인증</label> <input type="text" name="email-code"
				placeholder="인증번호입력" /> <input type="button" value="확인" /> <img
				class="verification-img" src="../../resource/images/required.png" />
		</div>
		<div id="id-check">
			<label>아이디</label> <input type="text" name="id" /> <input
				type="button" value="중복체크" /> <img class="verification-img"
				src="../../resource/images/required.png" />
		</div>
		...
		<div id="password">
			<label>비밀번호</label> <input type="password" name="password"
				placeholder="8-20자 영문,숫자,특수문자 혼합 " /> <img class="verification-img"
				src="../../resource/images/required.png" />
		</div>
		<div id="password-check">
			<label>비밀번호 확인</label> <input type="password" name="password-check"
				placeholder="" /> <img class="verification-img"
				src="../../resource/images/required.png" />
		</div>
		<div id="username">
			<label>이름</label> <input type="text" name="username" placeholder="" />
			<img class="verification-img"
				src="../../resource/images/required.png" />
		</div>
		<div id="birthday">
			<label>생년월일</label> <select name="user_birth_year">
			...
			<!-- <img class="verification-img" src="../../resource/images/required.png" /> -->
		</div>


		<div id="sign-up-check">
