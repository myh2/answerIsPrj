...
<div id="content">
	...
	<h2 class="hidden">나의 답변</h2>

	
	
	<form id="search-form" action="qna-answers-search" method="get">
		<fieldset>
...
<!-- 
	<div>
		<input type="button"  id="btn-ok"  value="test"  />	
	</div>
	 -->
	...
	<div id="answer-all">
		...
		<div class="answer-all-table">
		<c:forEach var="n" items="${list}">
		<div>
			<dl>
				<dd class="code">${n.code}</dd>

				<dd class="title"><a href="answers-detail?c=${n.blogCode }">${n.title}</a></dd>
...
<%-- 				<dd class="writer">${n.nickname}</dd>
 ...
 --%>
				...
				<dd class="content"><a href="answers-detail?c=${n.blogCode }">${n.content}</a></dd>

				<dd class="hashtag">${n.hashTag}</dd>

				<dd class="like">좋아요 ${n.like}</dd>

				<dd class="hate">싫어요 ${n.hate}</dd>
...
<%-- 		<div id="comment-list">
				...
				<table>
					...
					<tr>
						<td colspan="30"style="padding: 5px 0 2px 0; text-align: left; border: none;">
							<span style="font-weight: 600; color: #7e53ac;">작성자왈${writer} </span>
						</td>
					</tr>
					<tr>
						<td style="border-top: none; border-bottom: 1px solid #dededb;">내용이다으아아아ddddddddds${comment}</td>
						<td style="border-top: none; padding-left:30px;border-bottom: 1px solid #dededb;">2016-06-29${regdate}</td>
					</tr>
					
					<tr>
						<td colspan="30"style="padding: 5px 0 2px 0; text-align: left; border: none;">
							<span style="font-weight: 600; color: #7e53ac;">갑을병정${writer} </span>
						</td>
					</tr>
					<tr>
						<td style="border-top: none; border-bottom: 1px solid #dededb;">fuck uuuuuuuu${comment}</td>
						<td style="border-top: none; padding-left:30px;border-bottom: 1px solid #dededb;">2016-06-29${regdate}</td>
					</tr>
